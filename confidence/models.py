        ...
        for source in sources:
            if source:
                ...
                for merged_key, merged_origin in _merge(self._source,
                    ...
                    # TODO: with all the information being generated by _merge, we're now tracking self._source and
                    #       self._origins that have similar if disjunctly typed keys, could possibly be turned into a
