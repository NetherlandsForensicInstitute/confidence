...
from confidence.io import DEFAULT_LOAD_ORDER, dumpf, dumps, load, load_name, loaders, loadf, loads, Locality
...
__all__ = (
    ...
    'DEFAULT_LOAD_ORDER', 'dumpf', 'dumps', 'load', 'load_name', 'loaders', 'loadf', 'loads', 'Locality',
